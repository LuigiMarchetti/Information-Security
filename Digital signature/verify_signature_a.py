...
def main():
    ...
    try:
        # Load public key A
        public_key = load_public_key("pair_a/public_key.pem")
        
        # Verify the signature
        if verify_signature(document_path, signature_path, public_key):
            print("Signature is valid! The document was signed by key A.")
        else:
            print("Invalid signature! The document was NOT signed by key A or has been tampered with.")
